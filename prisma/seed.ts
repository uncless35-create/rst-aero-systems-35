...
const META: Record<string, Meta> = {
  ...
  "gotovyy-fpv-komplekt-dlya-novichka-dron-ochki-pult": {
    ...
    description: `Самый доступный способ войти в FPV с полным комплектом: распаковал, надел очки — полетел. Всё совместимо, забиндено и проверено нами перед отправкой.

Состав комплекта:
• Дрон Happymodel Mobula7 1S ELRS — легендарный тинивуп, на котором училась летать половина пилотов (лёгкий — без регистрации)
• Пульт RadioMaster T8L ELRS — надёжная аппаратура для старта
• FPV-шлем BetaFPV VR04 — большой экран, приём 5.8 ГГц

💰 Комплектом дешевле, чем покупать по отдельности.
✅ Бесплатно: бинд пульта и шлема, проверка перед отправкой. Останутся вопросы — мы на связи, поможем настроить.
...
📷 Хотите цифровую картинку как у DJI? В каталоге есть комплект на DJI O4 — это следующая ступень.
🚚 Отправка в течение 24 часов, доставка СДЭК по всей России.

Не уверены, что выбрать — напишите, честно подскажем, что нужно для старта, а что можно докупить потом.`,
    attributes: [["Уровень", "Для новичка"], ["Дрон", "Happymodel Mobula7 1S ELRS"], ["Пульт", "RadioMaster T8L ELRS"], ["Очки/шлем", "BetaFPV VR04 (5.8 ГГц)"]],
  },
  "komplekt-dlya-starta-v-fpv": {
    slug: "nabor-start-fpv",
    name: "Комплект для старта в FPV",
    description: `Полностью готовый комплект для старта в FPV из самых актуальных и свежих компонентов. Можем переукомплектовать набор под ваш вкус — изменить аппаратуру управления, тинивуп, добавить дополнительные аккумуляторы.

По наличию можем заменить пульт на TX12, TX15, T8L, GX12. Тинивуп — на Air75, Air65, Meteor75 Pro, Mobula7, Mobula8.

Цена указана за комплект в составе:
• Тинивуп BetaFPV Meteor75 Pro (в заводском комплекте уже 2 аккумулятора и зарядное устройство)
• Пульт RadioMaster Pocket ELRS + 2 аккумулятора 18650
• FPV-шлем BetaFPV VR04

По желанию аккуратно вскроем и проведём бинд пульта и шлема.`,
    attributes: [["Уровень", "Для старта"], ["Тинивуп", "BetaFPV Meteor75 Pro"], ["Пульт", "RadioMaster Pocket ELRS"], ["Очки/шлем", "BetaFPV VR04"]],
  },
  "fpv-komplekt-dlya-novichka-na-cifre-dji-o4-pod-klyuch": {
    ...
    description: `Готовый набор, чтобы начать летать FPV сразу и «на цифре» — с HD-картинкой DJI. В отличие от аналоговых наборов с мыльным изображением, здесь та же цифровая система, что у больших дронов DJI.

Состав комплекта:
• Дрон BetaFPV Meteor75 Pro с юнитом DJI O4 — лучший тинивуп для обучения (вес 38 г — без регистрации)
• Пульт RadioMaster Pocket ELRS + 2 аккумулятора 18650
• Очки DJI Goggles N3
...
🚚 Отправка в течение 24 часов, доставка СДЭК по всей России.`,
    attributes: [["Уровень", "Для новичка"], ["Видеосистема", "Цифровая (DJI O4)"], ["Дрон", "BetaFPV Meteor75 Pro + DJI O4"], ["Пульт", "RadioMaster Pocket ELRS"], ["Очки", "DJI Goggles N3"]],
  },
};
...
const PRICES: Record<string, number> = {
  ...
  // --- Готовые наборы ---
  "gotovyy-fpv-komplekt-dlya-novichka-dron-ochki-pult": 24560,
  "komplekt-dlya-starta-v-fpv": 26160,
  "fpv-komplekt-dlya-novichka-na-cifre-dji-o4-pod-klyuch": 49990,
};
